...
data_train = torchvision.datasets.ImageFolder("/home/dipesh/grad_cam/data/train", transform=transform)
data_test = torchvision.datasets.ImageFolder("/home/dipesh/grad_cam/data/test", transform=transform)
...
features.extend([torch.nn.Linear(4096, 21)])
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(8*8*128,8*8*128)
        self.fc2 = nn.Linear(8*8*128, 21)
...
def main():
    ...
    if (args.save_model):
        torch.save(model.state_dict(),"/home/dipesh/PyTorch/CIFAR_100/cifar-100-python/pt_files/file: train_acc:"+str(train_acc)+" test-acc:"+str(test_acc)+" epochs: "+str(args.epochs)+" CIFAR_100_cnn.pt")

    save_name_pkl = "/home/dipesh/PyTorch/CIFAR_100/cifar-100-python/pickel_files/file: train_acc:"+str(train_acc)+" test-acc:"+str(test_acc)+" epochs: "+str(args.epochs)+" end.pkl"
    save_name_txt = "/home/dipesh/PyTorch/CIFAR_100/cifar-100-python/models/file: train_acc:"+str(train_acc)+" test-acc:"+str(test_acc)+" epochs: "+str(args.epochs)+" end.txt"
